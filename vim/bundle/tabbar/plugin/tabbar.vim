...
if ! hasmapto('1') || !hasmapto('<M-1>')
      ...
      "else
            ...
            noremap <unique> <script> \a10 :call <SID>Bf_SwitchTo( 10)<CR>:<BS>
            noremap <unique> <script> \a11 :call <SID>Bf_SwitchTo( 11)<CR>:<BS>
            noremap <unique> <script> \a12 :call <SID>Bf_SwitchTo( 12)<CR>:<BS>
            noremap <unique> <script> \a13 :call <SID>Bf_SwitchTo( 13)<CR>:<BS>
            noremap <unique> <script> \a14 :call <SID>Bf_SwitchTo( 14)<CR>:<BS>
            noremap <unique> <script> \a15 :call <SID>Bf_SwitchTo( 15)<CR>:<BS>
            noremap <unique> <script> \a16 :call <SID>Bf_SwitchTo( 16)<CR>:<BS>
            noremap <unique> <script> \a17 :call <SID>Bf_SwitchTo( 17)<CR>:<BS>
            noremap <unique> <script> \a18 :call <SID>Bf_SwitchTo( 18)<CR>:<BS>
            noremap <unique> <script> \a19 :call <SID>Bf_SwitchTo( 19)<CR>:<BS>
            noremap <unique> <script> \a20 :call <SID>Bf_SwitchTo( 20)<CR>:<BS>
            noremap <unique> <script> \a21 :call <SID>Bf_SwitchTo( 21)<CR>:<BS>
            noremap <unique> <script> \a22 :call <SID>Bf_SwitchTo( 22)<CR>:<BS>
            noremap <unique> <script> \a23 :call <SID>Bf_SwitchTo( 23)<CR>:<BS>
            noremap <unique> <script> \a24 :call <SID>Bf_SwitchTo( 24)<CR>:<BS>
            noremap <unique> <script> \a25 :call <SID>Bf_SwitchTo( 25)<CR>:<BS>
            noremap <unique> <script> \a26 :call <SID>Bf_SwitchTo( 26)<CR>:<BS>
            noremap <unique> <script> \a27 :call <SID>Bf_SwitchTo( 27)<CR>:<BS>
            noremap <unique> <script> \a28 :call <SID>Bf_SwitchTo( 28)<CR>:<BS>
            noremap <unique> <script> \a29 :call <SID>Bf_SwitchTo( 29)<CR>:<BS>
